...
namespace velodyne_rawdata
{
  ...
  int RawData::setup(ros::NodeHandle &private_nh)
  {
    ...
    */
    private_nh.param("calibration", config_.calibrationFile, std::string("/home/yangjl/Desktop/sensor/VLP-16.yaml"));
   ...
   */
  void RawData::unpack(const velodyne::VelodynePacket &pkt, DataContainerBase& data)
  {
   ...
   *  @param pc shared pointer to point cloud (points are appended)
   */
  void RawData::unpack_vlp16(const velodyne::VelodynePacket &pkt, DataContainerBase& data)
  {
    float azimuth;
    float azimuth_diff;
